  ...
  return (
    <div className="home-container">
      ...
      <div className="home-header">
        ...
        >
          <span className="logo">RESUMEIO</span>
          <div data-thq="thq-navbar-nav" className="home-desktop-menu">
            <nav className="home-links">
              <span className="bodySmall">Home</span>
              <span className="home-nav22 bodySmall">Features</span>
              <span className="home-nav32 bodySmall">Templates</span>
          ...
          >
            <div className="home-nav">
              ...
              <nav className="home-links1">
                ...
                <span className="home-nav321 bodySmall">Templates</span>
          ...
          <div className="home-container01">
            ...
            <span className="home-hero-sub-heading bodyLarge">
              <span>
                <span>
                  <span>
                    Stand out from the crowd with a professionally designed
                    resume
                  </span>
                  <span>
                    <span
          ...
          <div className="home-features1">
            <div className="home-container02">
              ...
              <span className="home-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>
                      Experience the power of our resume builder with these key
                      features
                    </span>
                    <span>
                      <span
            ...
            <div className="home-container03">
              <FeatureCard
                ...
                subHeading="Intuitive design for creating resumes effortlessly"
              ></FeatureCard>
              <FeatureCard
                heading="Customizable Templates"
                subHeading="Choose from a variety of templates to suit your style"
              ></FeatureCard>
              <FeatureCard
                heading="Download in Multiple Formats"
                subHeading="Export your resume in PDF, Word, or other formats with ease"
              ></FeatureCard>
              <FeatureCard
                heading="Real-time Preview"
                subHeading="See how your resume looks as you make changes in real-time"
              ></FeatureCard>
            </div>
          </div>
        </div>
          ...
          <div className="home-container05">
            <div className="freePricingCard home-pricing-card">
              ...
              <div className="home-container08">
                <div className="home-container09">
                  ...
                  <span className="bodySmall">Basic resume templates</span>
                </div>
                <div className="home-container10">
                  <span className="home-text41">✔</span>
                  <span className="bodySmall">Download as PDF</span>
                </div>
                ...
                <div className="home-container12">
                  ...
                  <span className="bodySmall">Ads displayed on resumes</span>
                </div>
              </div>
            ...
            <div className="basicPricingCard home-pricing-card1">
              <div className="home-container13">
                ...
                <span className="bodySmall">
                  Upgrade for more customization and features
                </span>
              </div>
              ...
              <div className="home-container15">
                ...
                <div className="home-container17">
                  ...
                  <span className="bodySmall">More template options</span>
                </div>
                <div className="home-container18">
                  <span className="home-text52">✔</span>
                  <span className="bodySmall">Remove ads from resumes</span>
                </div>
                <div className="home-container19">
                  <span className="home-text53">✔</span>
                  <span className="bodySmall">Unlimited downloads</span>
                </div>
            ...
            <div className="proPricingCard home-pricing-card2">
              <div className="home-container21">
                ...
                <span className="bodySmall">
                  Unlock premium features for professional resumes
                </span>
              </div>
              ...
              <div className="home-container23">
                ...
                <div className="home-container25">
                  ...
                  <span className="bodySmall">Premium template designs</span>
                </div>
                <div className="home-container26">
                  <span className="home-text65">✔</span>
                  <span className="bodySmall">Custom color schemes</span>
                </div>
                ...
                <div className="home-container28">
                  ...
                  <span className="bodySmall">Phone support available</span>
                </div>
              </div>
        ...
        <div className="bannerContainer home-banner1">
          ...
          <span className="home-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
                  Our platform offers easy-to-use tools and templates to help
                  you craft a standout resume tailored to your career goals.
                  Whether you&apos;re a recent graduate or a seasoned
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container30">
              <Question1
                answer="To create a resume, simply sign up for an account and follow the step-by-step guide to fill in your information."
                question="How do I create a resume on this website?"
              ></Question1>
              <Question1
                answer="Yes, you can download your resume in various formats such as PDF, Word, or plain text."
                question="Can I download my resume in different formats?"
              ></Question1>
              <Question1
                answer="We take data security seriously and use encryption to protect your personal information."
                question="Is my personal information secure on this website?"
              ></Question1>
              <Question1
                answer="Yes, you can log in to your account at any time to make edits or updates to your resume."
                question="Can I edit my resume after I have created it?"
              ></Question1>
              <Question1
                answer="Our customer support team is available to assist you with any questions or problems you may have while using our website."
                question="Do you offer customer support for any issues I may encounter?"
              ></Question1>
            </div>
          </div>
        </div>
        ...
        <footer className="footerContainer home-footer1">
          <div className="home-container31">
            ...
            <nav className="home-nav1">
              ...
              <span className="home-nav322 bodySmall">Templates</span>
